...
export default function CtaSection() {
  return (
    <section className="cta-section py-30 px-6 text-center bg-cream">
      <div className="cta-inner max-w-170 mx-auto">
        ...
        <p className="text-[17px] text-muted font-light leading-[1.65] max-w-125 mx-auto mt-4 mb-10">
          Crie seu primeiro álbum em menos de dois minutos. Grátis, sem cartão de crédito.
        </p>
        <Link
          href="/register"
          className="inline-block bg-ink text-cream px-11 py-4.5 rounded-full text-base font-medium no-underline hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(26,22,18,0.22)] shadow-[0_4px_20px_rgba(26,22,18,0.15)] transition-transform"
        >
          Criar evento grátis →
        </Link>
